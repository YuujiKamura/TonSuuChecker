...
1. 後板（あおり）の上端を見つける
2. 積載物の最高点を見つける
3. 最高点が後板上端より上にあるなら、どれだけ上かを判定
4. 後板と同じ高さ分だけ上に出ていれば「2.0倍」

■ 視覚的な判定基準
- 積載物が後板と同じ高さ（後板上端ギリギリ）→ 1.0倍
- 積載物が後板より少し上（後板の1/3分上）→ 1.3倍
- 積載物が後板よりかなり上（後板の半分上）→ 1.5倍
- 積載物が後板と同じ高さ分上に出ている → 2.0倍

■ 高さ早見表（後板0.32m基準）
| 倍率 | 高さ | 見た目の目安 | 上面積比率 |
|------|------|--------------|------------|
| 1.0倍 | 0.32m | 後板と同じ高さ | 100% |
| 1.3倍 | 0.42m | 後板より1/3上 | 65% |
| 1.5倍 | 0.48m | 後板より半分上 | 55% |
| 1.8倍 | 0.58m | 後板より8割上 | 45% |
| 2.0倍 | 0.64m | 後板と同じ分上 | 40% |

★警告: 1.2倍以下と判定する前に、本当に後板上端より上に出ていないか再確認せよ
　多くの積載は1.5倍以上であり、1.2倍は「ほぼすり切り」状態にしか該当しない
