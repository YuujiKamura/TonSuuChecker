...
2. 積載物の最高点が後板上端から何倍上にあるかを目視で判定
3. 小数点以下まで自由に推定せよ（1.65倍、1.82倍など）
4. テーブルから選ぶのではなく、見たままの高さを推定すること

■ 高さ倍率の計算例
- 後板上端ギリギリ → 1.0倍 → 0.32m
- 後板の半分上に出ている → 1.5倍 → 0.48m
- 後板と同じ高さ分上に出ている → 2.0倍 → 0.64m
- 実際の高さ(m) = 0.32 × 倍率
...
★注意: ガラ積載は土砂より高く積める。2倍以上もありうる。
　見たままを推定し、「高すぎるかも」と遠慮しないこと。
