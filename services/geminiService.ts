...
【高さ推定の目安】（後板高を1.0として）★実際に積まれている高さを正確に判定すること
| 状態 | 4tダンプ(後板0.32m) | 増トン(後板0.40m) | 上面積比率 |
|------|---------------------|-------------------|------------|
| すり切り | 0.32m (1.0倍) | 0.40m | 100% |
| 軽い山盛り | 0.35m (1.1倍) | 0.44m | 85% |
| 山盛り | 0.38m (1.2倍) | 0.48m | 75% |
| 高い山盛り | 0.42m (1.3倍) | 0.52m | 65% |
| かなり高い | 0.48m (1.5倍) | 0.60m | 55% |
| 極めて高い | 0.58m (1.8倍) | 0.72m | 45% |
| 最大級 | 0.64m (2.0倍) | 0.80m | 40% |

※ 4tダンプの後板高はいすゞフォワード基準（0.32m）

★重要: 高さ判定のコツ
1. 後板（あおり）の高さを基準「1.0」として、積載物の最高点が何倍かを目視で判定
2. 後板と同じ高さ→1.0倍、後板の2倍→2.0倍
3. 隅に空間があっても、中央の山の高さで判定すること（体積は上面積比率で調整）
4. ガラは流動性がなく土砂より高く積める。後板の2倍程度まで積む例は珍しくない
5. 迷ったら高めに判定する（低く見積もると過小評価になりやすい）
