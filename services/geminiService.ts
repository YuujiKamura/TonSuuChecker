...
| 状態 | 4tダンプ(後板0.34m) | 増トン(後板0.40m) | 上面積比率 |
|------|---------------------|-------------------|------------|
| すり切り | 0.34m (1.0倍) | 0.40m | 100% |
| 軽い山盛り | 0.37m (1.1倍) | 0.44m | 85% |
| 山盛り | 0.41m (1.2倍) | 0.48m | 75% |
| 高い山盛り | 0.44m (1.3倍) | 0.52m | 65% |
| かなり高い | 0.51m (1.5倍) | 0.60m | 55% |
| 極めて高い | 0.61m (1.8倍) | 0.72m | 45% |
| 最大級 | 0.68m (2.0倍) | 0.80m | 40% |
